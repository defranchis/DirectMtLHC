...
mergeImpacts = {'LHCHAD':['HADR','SLEPB','BFRAG']}
...
def main():
    ...
    if not args.unblind:
        LHC_full = LHC_object(obj_ATLAS, obj_CMS, blind=True, separateCombinations=False, mergeImpacts=mergeImpacts)
        LHC_full.printResults()
        LHC_full.printImpactsSorted()

        LHC_sep = LHC_object(obj_ATLAS, obj_CMS, blind=True, separateCombinations=True, mergeImpacts=mergeImpacts)
        LHC_sep.printResults()
        LHC_sep.printImpactsSorted()
    
    LHC_full_unblind = LHC_object(obj_ATLAS, obj_CMS, blind=False, separateCombinations=False, mergeImpacts=mergeImpacts)
    LHC_sep_unblind = LHC_object(obj_ATLAS, obj_CMS, blind=False, separateCombinations=True, mergeImpacts=mergeImpacts)
